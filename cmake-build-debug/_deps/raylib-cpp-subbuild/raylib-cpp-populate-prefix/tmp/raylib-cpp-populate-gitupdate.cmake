...
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe" show-ref 21d26ca66e3a8fc70a39ad13b40dcabbc1840a78
  WORKING_DIRECTORY "D:/Projects/CPP/CPPTest/cmake-build-debug/_deps/raylib-cpp-src"
...
if("${show_ref_output}" MATCHES "refs/remotes/21d26ca66e3a8fc70a39ad13b40dcabbc1840a78")
  string(REGEX MATCH "^([^/]+)/(.+)$" _unused "21d26ca66e3a8fc70a39ad13b40dcabbc1840a78")
  set(git_remote "${CMAKE_MATCH_1}")
  set(git_tag "${CMAKE_MATCH_2}")
else()
  set(git_remote "origin")
  set(git_tag "21d26ca66e3a8fc70a39ad13b40dcabbc1840a78")
endif()

# This will fail if the tag does not exist (it probably has not been fetched
# yet).
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe" rev-list --max-count=1 21d26ca66e3a8fc70a39ad13b40dcabbc1840a78
  WORKING_DIRECTORY "D:/Projects/CPP/CPPTest/cmake-build-debug/_deps/raylib-cpp-src"
  RESULT_VARIABLE error_code
...
if(error_code OR is_remote_ref OR NOT ("${tag_sha}" STREQUAL "${head_sha}"))
  ...
  if(is_remote_ref)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'D:/Projects/CPP/CPPTest/cmake-build-debug/_deps/raylib-cpp-src/'.\nYou will have to resolve the conflicts manually")
    endif()
    ...
    if(need_stash)
      ...
      if(error_code)
        ...
        if(error_code)
          ...
          message(FATAL_ERROR "\nFailed to unstash changes in: 'D:/Projects/CPP/CPPTest/cmake-build-debug/_deps/raylib-cpp-src/'.\nYou will have to resolve the conflicts manually")
        endif()
      endif()
    endif()
  else()
